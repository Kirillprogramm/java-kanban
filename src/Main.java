...
public class Main {
    public static void main(String[] args) {
        ...
        Task taskFirst = new Task(1,"Поесть","Принять пищу", "NEW");
        Task taskSecond = new Task(2,"Поспать","Хорошенько выспаться", "DONE");
        ...
        EpicTask epicTaskFirst = new EpicTask(1, "Закончить учебу",
        ...
        EpicTask epicTaskSecond = new EpicTask(2,"Сменить работу"
